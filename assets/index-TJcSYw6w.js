(function(){const s=document.createElement("link").relList;if(s&&s.supports&&s.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))r(i);new MutationObserver(i=>{for(const o of i)if(o.type==="childList")for(const n of o.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&r(n)}).observe(document,{childList:!0,subtree:!0});function e(i){const o={};return i.integrity&&(o.integrity=i.integrity),i.referrerPolicy&&(o.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?o.credentials="include":i.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function r(i){if(i.ep)return;i.ep=!0;const o=e(i);fetch(i.href,o)}})();const k="modulepreload",I=function(t){return"/"+t},f={},b=function(s,e,r){let i=Promise.resolve();if(e&&e.length>0){document.getElementsByTagName("link");const n=document.querySelector("meta[property=csp-nonce]"),l=(n==null?void 0:n.nonce)||(n==null?void 0:n.getAttribute("nonce"));i=Promise.allSettled(e.map(c=>{if(c=I(c),c in f)return;f[c]=!0;const d=c.endsWith(".css"),u=d?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${c}"]${u}`))return;const a=document.createElement("link");if(a.rel=d?"stylesheet":k,d||(a.as="script"),a.crossOrigin="",a.href=c,l&&a.setAttribute("nonce",l),document.head.appendChild(a),d)return new Promise((g,A)=>{a.addEventListener("load",g),a.addEventListener("error",()=>A(new Error(`Unable to preload CSS for ${c}`)))})}))}function o(n){const l=new Event("vite:preloadError",{cancelable:!0});if(l.payload=n,window.dispatchEvent(l),!l.defaultPrevented)throw n}return i.then(n=>{for(const l of n||[])l.status==="rejected"&&o(l.reason);return s().catch(o)})};function p(t){t.innerHTML=`
     <section class="hero">
...
You can choose readings via telephone, face to face. There are set time options for readings and it is also possible to book a reading that at the end is charged by the minute. I offer a business consultancy service based on many years of personal experience and the added advantage of the psychic insight. For bookings follow the Link
    ...
    `}const R=Object.freeze(Object.defineProperty({__proto__:null,renderAboutPage:L},Symbol.toStringTag,{value:"Module"}));function N(t){t.innerHTML=`
...
`;C.appendChild(m);C.appendChild(h);let E=0;window.addEventListener("scroll",()=>{const t=window.pageYOffset;t>50?(m.classList.add("scrolled"),t>E?m.classList.add("hidden"):m.classList.remove("hidden"),E=t):m.classList.remove("scrolled","hidden")});function T(){const t=document.querySelectorAll(".scroll-animate"),s=(i,o=0)=>i.getBoundingClientRect().top<=(window.innerHeight||document.documentElement.clientHeight)-o,e=()=>{t.forEach((i,o)=>{s(i,100)&&(i.style.transitionDelay=`${o*.1}s`,i.classList.add("visible"))})};let r;window.addEventListener("scroll",()=>{clearTimeout(r),r=setTimeout(e,50)}),e()}D(m,h);p(h);const $=new MutationObserver(()=>{document.querySelector(".pricing-section")&&T()});$.observe(h,{childList:!0,subtree:!0});function q(){document.addEventListener("click",t=>{if(t.target.closest(".card-button")){const e=document.querySelector(".booking-notice");e&&(e.scrollIntoView({behavior:"smooth",block:"center"}),e.classList.add("highlight-pulse"),setTimeout(()=>e.classList.remove("highlight-pulse"),2e3))}})}window.addEventListener("routechange",t=>{const s=t.detail.path.toLowerCase();switch(h.innerHTML="",s){case"/contact":b(async()=>{const{renderContactPage:e}=await Promise.resolve().then(()=>M);return{renderContactPage:e}},void 0).then(({renderContactPage:e})=>e(h)),document.title="Deborah's Psychic Readings - Contact";break;case"/about":b(async()=>{const{renderAboutPage:e}=await Promise.resolve().then(()=>R);return{renderAboutPage:e}},void 0).then(({renderAboutPage:e})=>e(h)),document.title="Deborah's Psychic Readings - About";break;default:p(h),document.title="Deborah's Psychic Readings";break}});document.addEventListener("DOMContentLoaded",()=>{T(),q()});
