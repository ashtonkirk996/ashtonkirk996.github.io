(function(){const s=document.createElement("link").relList;if(s&&s.supports&&s.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))r(i);new MutationObserver(i=>{for(const o of i)if(o.type==="childList")for(const n of o.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&r(n)}).observe(document,{childList:!0,subtree:!0});function t(i){const o={};return i.integrity&&(o.integrity=i.integrity),i.referrerPolicy&&(o.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?o.credentials="include":i.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function r(i){if(i.ep)return;i.ep=!0;const o=t(i);fetch(i.href,o)}})();const k="modulepreload",O=function(e){return"/"+e},f={},b=function(s,t,r){let i=Promise.resolve();if(t&&t.length>0){document.getElementsByTagName("link");const n=document.querySelector("meta[property=csp-nonce]"),l=(n==null?void 0:n.nonce)||(n==null?void 0:n.getAttribute("nonce"));i=Promise.allSettled(t.map(c=>{if(c=O(c),c in f)return;f[c]=!0;const d=c.endsWith(".css"),u=d?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${c}"]${u}`))return;const a=document.createElement("link");if(a.rel=d?"stylesheet":k,d||(a.as="script"),a.crossOrigin="",a.href=c,l&&a.setAttribute("nonce",l),document.head.appendChild(a),d)return new Promise((g,P)=>{a.addEventListener("load",g),a.addEventListener("error",()=>P(new Error(`Unable to preload CSS for ${c}`)))})}))}function o(n){const l=new Event("vite:preloadError",{cancelable:!0});if(l.payload=n,window.dispatchEvent(l),!l.defaultPrevented)throw n}return i.then(n=>{for(const l of n||[])l.status==="rejected"&&o(l.reason);return s().catch(o)})};function v(e){e.innerHTML=`
     <section class="hero">
...
You can choose readings via telephone, face to face. There are set time options for readings and it is also possible to book a reading that at the end is charged by the minute. I offer a business consultancy service based on many years of personal experience and the added advantage of the psychic insight. For bookings follow the Link
    ...
    `}const N=Object.freeze(Object.defineProperty({__proto__:null,renderAboutPage:L},Symbol.toStringTag,{value:"Module"}));function R(e){e.innerHTML=`
  ...
  `;const s=e.querySelector("#contactForm");s==null||s.addEventListener("submit",t=>{t.preventDefault(),alert("This is a demo, no message was sent.")})}const M=Object.freeze(Object.defineProperty({__proto__:null,renderContactPage:S},Symbol.toStringTag,{value:"Module"}));function H(e){e.innerHTML=`
    ...
    `}function _(e,s){const t=document.createElement("nav");t.className="main-nav";const r=e.querySelector(".logo");if(r){r.innerHTML="";const n=document.createElement("img");n.src="images/logo.png",n.alt="Deborah's Psychic Readings Logo",n.className="logo-img",n.style.cursor="pointer",n.addEventListener("click",()=>{y("/",s,v)}),r.appendChild(n)}const i=[{title:"HOME",path:"/",action:v},{title:"PSYCHIC READINGS",path:"/readings",action:I},{title:"ABOUT",path:"/about",action:L},{title:"REVIEWS",path:"/reviews",action:R},{title:"CONTACT ME",path:"/contact",action:S},{title:"TERMS",path:"/terms",action:H}],o=document.createElement("ul");o.className="menu-list",i.forEach(n=>{const l=document.createElement("li"),c=document.createElement("a");c.href=n.path,c.addEventListener("click",g=>{g.preventDefault(),y(n.path,s,n.action)});const d=document.createElement("span");d.className="menu-item-text",d.textContent=n.title;const u=document.createElementNS("http://www.w3.org/2000/svg","svg");u.setAttribute("class","menu-star"),u.setAttribute("width","9"),u.setAttribute("height","9"),u.setAttribute("viewBox","0 0 9 9");const a=document.createElementNS("http://www.w3.org/2000/svg","path");a.setAttribute("d","M0 4.5A4.456 4.456 0 0 0 4.5 0 4.456 4.456 0 0 0 9 4.5 4.456 4.456 0 0 0 4.5 9 4.456 4.456 0 0 0 0 4.5Z"),a.setAttribute("stroke-linecap","square"),a.setAttribute("stroke-linejoin","bevel"),a.setAttribute("stroke-miterlimit","10"),u.appendChild(a),d.appendChild(u),c.appendChild(d),l.appendChild(c),o.appendChild(l)}),t.appendChild(o),e.appendChild(t)}function y(e,s,t){window.history.pushState({},"",e),B(e),s.innerHTML="",t(s),window.scrollTo(0,0)}function B(e){const s=document.getElementById("dynamic-canonical");if(!s)return;const t="https://deborahspsychicreadings.co.nz",r={"/":`${t}/`,"/readings":`${t}/readings`,"/about":`${t}/about`,"/reviews":`${t}/reviews`,"/contact":`${t}/contact`,"/terms":`${t}/terms`};s.href=r[e]||`${t}/`}const T=document.querySelector("#app"),h=document.createElement("main"),w=new URL(window.location.href);let m="";if(w.search){const e=w.search.slice(2);e&&!e.startsWith("index.html")&&(m=`/${e.split("?")[0]}`)}m&&(window.history.replaceState({},"",m),window.dispatchEvent(new CustomEvent("routechange",{detail:{path:m}})));const A=document.createElement("div");A.innerHTML=`
  <div class="background-circle circle1"></div>
  <div class="background-circle circle2"></div>
`;document.body.prepend(A);const p=document.createElement("header");p.innerHTML=`
  <div class="logo">
    <span>DEBORAH'S <br> PSYCHIC READINGS</span>
  </div>
`;T.appendChild(p);T.appendChild(h);let E=0;window.addEventListener("scroll",()=>{const e=window.pageYOffset;e>50?(p.classList.add("scrolled"),e>E?p.classList.add("hidden"):p.classList.remove("hidden"),E=e):p.classList.remove("scrolled","hidden")});function C(){const e=document.querySelectorAll(".scroll-animate"),s=(i,o=0)=>i.getBoundingClientRect().top<=(window.innerHeight||document.documentElement.clientHeight)-o,t=()=>{e.forEach((i,o)=>{s(i,100)&&(i.style.transitionDelay=`${o*.1}s`,i.classList.add("visible"))})};let r;window.addEventListener("scroll",()=>{clearTimeout(r),r=setTimeout(t,50)}),t()}_(p,h);v(h);const D=new MutationObserver(()=>{document.querySelector(".pricing-section")&&C()});D.observe(h,{childList:!0,subtree:!0});function $(){document.addEventListener("click",e=>{if(e.target.closest(".card-button")){const t=document.querySelector(".booking-notice");t&&(t.scrollIntoView({behavior:"smooth",block:"center"}),t.classList.add("highlight-pulse"),setTimeout(()=>t.classList.remove("highlight-pulse"),2e3))}})}window.addEventListener("routechange",e=>{const s=e.detail.path;document.title=`Deborah's Psychic Readings - ${s.slice(1)||"Home"}`,h.innerHTML="",s==="/contact"?b(async()=>{const{renderContactPage:t}=await Promise.resolve().then(()=>M);return{renderContactPage:t}},void 0).then(({renderContactPage:t})=>t(h)):s==="/about"?b(async()=>{const{renderAboutPage:t}=await Promise.resolve().then(()=>N);return{renderAboutPage:t}},void 0).then(({renderAboutPage:t})=>t(h)):v(h)});document.addEventListener("DOMContentLoaded",()=>{C(),$()});
